  ...
  <body>
    ...
    <div class="container marketing">
        <!-- Three columns of text below the carousel -->
              <div class="row">
                <div class="col-lg-4">
                  <img src="img/yuxi.png" width="140px" height="140px" class="img-circle" alt="Generic placeholder image">
                  <h2>Yuxi He</h2>
                  <p>yuxihe2014@u.northwestern.edu</p>
                ...
                <div class="col-lg-4">
                  <img class="img-circle" src="img/sai.png" width="140px" height="140px" alt="Generic placeholder image">
                  <h2>Kolli Sai Praneeth</h2>
                  <p>saikolli2012@u.northwestern.edu</p>
                ...
                <div class="col-lg-4">
                   <img class="img-circle" src="img/yang.png" width="140px" height="140px" alt="Generic placeholder image">
                  <h2>Yang Zhang</h2>
